...
print('tada:     ', run(scale_tada, TADA))
print('tada2:    ', run(scale_new, TADA))
...
print('tada:         ', run(gamma_tada, TADA))
print('tada new:     ', run(gamma_new, TADA))
