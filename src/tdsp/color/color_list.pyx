...
"""
    ...
    def __setitem__(self, object key, object x):
        ...
        if isinstance(key, slice):
            ...
            if sliceIntoVector(_to_ColorList(x).colors, self.colors,
                               begin, end, step):
                return
    ...
    def limit(self, *, min=None, max=None):
        ...
        if max is not None:
            if isinstance(max, Number):
                ...
                maxInto(_to_ColorList(max).colors, self.colors)
        if min is not None:
            if isinstance(min, Number):
                minInto(<float> min, self.colors)
            else:
                minInto(_to_ColorList(min).colors, self.colors)
        return self
    ...
    def pow(self, float c):
        ...
        if isinstance(c, Number):
            ...
            powInto(_to_ColorList(c).colors, self.colors)
        return self
    ...
    def rpow(self, c):
        ...
        if isinstance(c, Number):
            ...
            rpowInto(_to_ColorList(c).colors, self.colors)
        return self
    ...
    def __iadd__(self, c):
        if isinstance(c, Number):
            ...
            addInto(_to_ColorList(c).colors, self.colors)
        return self
    ...
    def __imul__(self, c):
        if isinstance(c, Number):
            ...
            multiplyInto(_to_ColorList(c).colors, self.colors)
        return self
    ...
    def __isub__(self, c):
        if isinstance(c, Number):
             ...
             subtractInto(_to_ColorList(c).colors, self.colors)
        return self
    ...
    def __itruediv__(self, c):
        if isinstance(c, Number):
            ...
            divideInto(_to_ColorList(c).colors, self.colors)
        return self
    ...
    def __add__(self, c):
        ...
        if isinstance(c, Number):
            ...
            addOver((<_ColorList> self).colors, _to_ColorList(c).colors, cl.colors)
        elif isinstance(self, Number):
            addOver(<float> self, _to_ColorList(c).colors, cl.colors)
        else:
    ...
    def __mul__(self, c):
        ...
        if isinstance(c, Number):
            ...
            mulOver((<_ColorList> self).colors, _to_ColorList(c).colors, cl.colors)
        elif isinstance(self, Number):
            mulOver(<float> self, _to_ColorList(c).colors, cl.colors)
        else:
    ...
    def __pow__(self, c, mod):
        ...
        if isinstance(c, Number):
            ...
            powOver((<_ColorList> self).colors, _to_ColorList(c).colors, cl.colors)
        elif isinstance(self, Number):
            powOver(<float> self, _to_ColorList(c).colors, cl.colors)
        else:
    ...
    def __sub__(self, c):
        ...
        if isinstance(c, Number):
            ...
            subOver((<_ColorList> self).colors, _to_ColorList(c).colors, cl.colors)
        elif isinstance(self, Number):
            subOver(<float> self, _to_ColorList(c).colors, cl.colors)
        else:
    ...
    def __truediv__(self, c):
        ...
        if isinstance(c, Number):
            ...
            divOver((<_ColorList> self).colors, _to_ColorList(c).colors, cl.colors)
        elif isinstance(self, Number):
            divOver(<float> self, _to_ColorList(c).colors, cl.colors)
        else:
...
cdef _ColorList _to_ColorList(object value):
