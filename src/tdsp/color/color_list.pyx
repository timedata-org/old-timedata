...
"""
    ...
    def __add__(self, c):
        ...
        if isinstance(c, Number):
            ...
            addOver((<_ColorList> self).colors,
                    _to_ColorList(c).colors, cl.colors)
        elif isinstance(self, Number):
            addOver(<float> self, _to_ColorList(c).colors, cl.colors)
        else:
            addOver(_ColorList(self).colors,
                    (<_ColorList> c).colors, cl.colors)
        return cl
    ...
    def __mul__(self, c):
        ...
        if isinstance(c, Number):
            ...
            mulOver((<_ColorList> self).colors,
                    _to_ColorList(c).colors, cl.colors)
        elif isinstance(self, Number):
    ...
    def __pow__(self, c, mod):
        ...
        if isinstance(c, Number):
            ...
            powOver((<_ColorList> self).colors,
                    _to_ColorList(c).colors, cl.colors)
        elif isinstance(self, Number):
    ...
    def __sub__(self, c):
        ...
        if isinstance(c, Number):
            ...
            subOver((<_ColorList> self).colors,
                    _to_ColorList(c).colors, cl.colors)
        elif isinstance(self, Number):
    ...
    def __truediv__(self, c):
        ...
        if isinstance(c, Number):
            ...
            divOver((<_ColorList> self).colors,
                    _to_ColorList(c).colors, cl.colors)
        elif isinstance(self, Number):
